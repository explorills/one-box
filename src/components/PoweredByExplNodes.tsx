...
const STYLES = {
  ...
  sizes: {
    sm: { fontSize: '12px', paddingX: '8px', paddingY: '4px', borderRadius: '4px' },
  ...
  shadow: {
    ...
    hover: '0 4px 8px rgba(0,0,0,0.4), 0 0 12px oklch(0.58 0.20 280 / 0.6), inset 0 1px 0 rgba(255,255,255,0.15)',
  },
} as const
