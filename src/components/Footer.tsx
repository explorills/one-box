  ...
  const SocialLinks = () => (
    <div className="flex items-center gap-3">
      <a
        ...
        className="hover:text-primary transition-all duration-300 hover:scale-110 hover:shadow-[0_2px_8px_oklch(0.58_0.20_280/0.6)] hover:translate-y-[-1px] rounded-full p-1"
        aria-label="Discord"
      >
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-40 w-full border-t border-border bg-background/95 backdrop-blur py-3">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="hidden min-[480px]:flex items-center justify-between">
          <span className="text-[11px] sm:text-xs text-muted-foreground shrink-0">
            <a
              href="https://expl.one"
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary hover:text-primary/80 transition-all duration-300 hover:scale-110 hover:shadow-[0_2px_8px_oklch(0.58_0.20_280/0.6)] hover:translate-y-[-1px] cursor-pointer underline rounded-full px-1"
            >
              EXPL.ONE
            </a>
